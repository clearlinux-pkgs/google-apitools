...
Version  : 0.5.15
Release  : 8
URL      : https://pypi.debian.net/google-apitools/google-apitools-0.5.15.tar.gz
Source0  : https://pypi.debian.net/google-apitools/google-apitools-0.5.15.tar.gz
...
%prep
%setup -q -n google-apitools-0.5.15
...
export LANG=C
export SOURCE_DATE_EPOCH=1505938037
